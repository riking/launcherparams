...
/* 103 */         if (result.trim().equals("Bad login")) {
/* 104 */           showError("Login failed");
/* 105 */         } else if (result.trim().equals("Old version")) {
/* 106 */           this.loginForm.setOutdated();
/* 107 */           showError("Outdated launcher");
/*     */         } else {
...
/* Location:           /home/kane/Desktop/minecraft.jar
